...
contract ERC721BatchTransferToSingleWalletUnitTest is TestBase {
...
contract ERC721BatchTransferSafeToSingleWalletUnitTest is TestBase {
    ERC721Mock internal _erc721;
    IERC721 internal erc721;
    ERC721BatchTransfer internal sut;
    ...
    function test_safeBatchTransferToSingleWallet_WhenAlephaoTransferItsTokens()
        public
    {
        HEVM.startPrank(A.alephao);
        _erc721.setApprovalForAll(address(sut), true);
        sut.safeBatchTransferToSingleWallet(erc721, A.cassie, alephaoTokens);
        HEVM.stopPrank();
    ...
    function test_safeBatchTransferToSingleWallet_WhenAlephaoTransferItsTokensUsingApprove()
        public
    {
        HEVM.startPrank(A.alephao);
        _erc721.approve(address(sut), 1);
    ...
    function test_safeBatchTransferToSingleWallet_WhenAlephaoTransferItsOwnTokensButContractIsNotApproved()
        public
    {
        HEVM.prank(A.alephao);
        HEVM.expectRevert("ERC721: caller is not token owner or approved");
    ...
    function test_safeBatchTransferToSingleWallet_WhenAlephaoTransferNonApprovedTokens()
        public
    {
        HEVM.startPrank(A.alephao);
        _erc721.approve(address(sut), 1);
    ...
    function test_safeBatchTransferToSingleWallet_WhenAlephaoTransfersBobTokens()
        public
    {
        HEVM.startPrank(A.alephao);
        _erc721.setApprovalForAll(address(sut), true);
        HEVM.expectRevert(Errors.NotOwnerOfToken());
        sut.safeBatchTransferToSingleWallet(erc721, A.cassie, bobTokens);
        HEVM.stopPrank();
    }

    function test_safeBatchTransferToSingleWallet_WhenAlephaoTransferingSomeAlephaoTokensAndSomeBobTokens()
        public
    {
        uint256[] memory tokenIds = new uint256[](5);
        tokenIds[0] = alephaoTokens[0];
        ...
        _erc721.setApprovalForAll(address(sut), true);
        HEVM.expectRevert(Errors.NotOwnerOfToken());
        sut.safeBatchTransferToSingleWallet(erc721, A.cassie, tokenIds);
        HEVM.stopPrank();
    }
}
...
contract ERC721BatchTransferSafeToMultipleWalletsUnitTest is TestBase {
    ERC721Mock internal _erc721;
    IERC721 internal erc721;
    ERC721BatchTransfer internal sut;
    ...
    function test_safeBatchTransferToMultipleWallets_WhenAlephaoTransferItsTokens()
        public
    {
        HEVM.startPrank(A.alephao);
        _erc721.setApprovalForAll(address(sut), true);
    ...
    function test_safeBatchTransferToMultipleWallets_WhenAlephaoTransferItsTokensUsingApprove()
        public
    {
        HEVM.startPrank(A.alephao);
        _erc721.approve(address(sut), 1);
    ...
    function test_safeBatchTransferToMultipleWallets_WhenAlephaoTransferItsOwnTokensButContractIsNotApproved()
        public
    {
        HEVM.prank(A.alephao);
        HEVM.expectRevert("ERC721: caller is not token owner or approved");
    ...
    function test_safeBatchTransferToMultipleWallets_WhenAlephaoTransferNonApprovedTokens()
        public
    {
        HEVM.startPrank(A.alephao);
        _erc721.approve(address(sut), 1);
    ...
    function test_safeBatchTransferToMultipleWallets_WhenAlephaoTransfersBobTokens()
        public
    {
        HEVM.startPrank(A.alephao);
        _erc721.setApprovalForAll(address(sut), true);
        HEVM.expectRevert(Errors.NotOwnerOfToken());
        sut.safeBatchTransferToMultipleWallets(erc721, tos, bobTokens);
        HEVM.stopPrank();
    }

    function test_safeBatchTransferToMultipleWallets_WhenAlephaoTransferingSomeAlephaoTokensAndSomeBobTokens()
        public
    {
        uint256[] memory tokenIds = new uint256[](5);
        tokenIds[0] = alephaoTokens[0];
        ...
        _erc721.setApprovalForAll(address(sut), true);
        HEVM.expectRevert(Errors.NotOwnerOfToken());
        sut.safeBatchTransferToMultipleWallets(erc721, tos, tokenIds);
        HEVM.stopPrank();
    }
}
