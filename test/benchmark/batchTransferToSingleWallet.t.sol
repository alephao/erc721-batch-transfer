...
contract BatchTransferToSingleWalletBenchmarkTest is TestBase {
    ...
    function test_batchTransferToSingleWallet_5_WhenWalletOwnNoTokens() public {
        HEVM.prank(A.alephao);
        sut.batchTransferToSingleWallet(erc721, A.sofia, alephaoTokens);
    }

    function test_batchTransferToSingleWallet_5_WhenWalletOwnAToken() public {
        HEVM.prank(A.alephao);
        sut.batchTransferToSingleWallet(erc721, A.bob, alephaoTokens);
    }
}
